...
[neovim](https://github.com/rust-analyzer/rust-analyzer) plugin for [asdf](https://github.com/asdf-vm/asdf) version manager.

## Install

```
asdf plugin-add rust-analyzer https://github.com/aniaan/asdf-neovim.git
```
